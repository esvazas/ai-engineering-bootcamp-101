...
from qdrant_client import QdrantClient, qdrant_fastembed
from qdrant_client.models import Prefetch, Filter, FusionQuery, FieldCondition, MatchText
...
def rag_pipeline_wrapper(question, top_k=5):
    ...
    for id in result['answer'].retrieved_context_ids:
        ...
        image_url = payload['first_large_image']
        price = payload['price']
